...
public interface PharmacyRepository extends JpaRepository<Pharmacy, Long> {
    ...
    @Query(value =
        "SELECT * FROM Pharmacy WHERE name like %:name%", nativeQuery = true)
    List<Pharmacy> findPharmaciesWithKeyword(@Param("name") String keyword);

    List<Pharmacy> findByName(String agencyName);
}
