...
public interface HospitalRepository extends JpaRepository<Hospital, Long> {
    ...
    @Query(value =
        "SELECT * FROM Hospital WHERE name like %:name%", nativeQuery = true)
    List<Hospital> findHospitalsWithKeyword(@Param("name") String keyword);
    ...
    @Query(value =
        "SELECT * FROM Hospital WHERE is_er_operate = true and name like %:name%", nativeQuery = true)
    List<Hospital> findERWithKeyword(@Param("name") String keyword);

    List<Hospital> findByName(String agencyName);
}
