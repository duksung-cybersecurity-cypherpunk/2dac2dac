  ...
  const fetchData = async () => {
    try {
      const response = await fetch(
        `http://203.252.213.209:8080/api/v1/healthList/vaccination/${userId}`
      );
                    ...
                    <View style={{ flex: 1 }}>
                      ...
                      <View style={styles.hospitalInfoContainer}>
                        ...
                        <View style={[{ padding: 5 }]}>
                          ...
                          >
                            <Text
                              style={[styles.timeText, { color: "#94C973" }]}
                            >
                              {" "}
                              ㆍ오늘 예약 |{" "}
                            </Text>
                            <Text
                              style={[styles.timeText, { color: "#D6D6D6" }]}
                            >
                              {" "}
                      ...
                      <View style={styles.vaccinInfo}>
                        ...
                        />
                        <Text style={[styles.vaccText, { color: "#94C973" }]}>
                          {" "}
                          {item.vaccSeries}차 {item.vaccName}
                        </Text>
                        <Text style={[styles.vaccText, { color: "#737373" }]}>
                          {" "}
                          접종 완료하셨습니다.
                        </Text>
                      </View>
