      ...
      <View style={styles.row}>
        {
          cnt === 0 ? (
            <View style={[{ alignItems: "center" }, { paddingTop: 250 }]}>
              ...
              <Text style={[styles.hospitalName, { paddingTop: 20 }, { paddingBottom: 10 }]}> 확인된 처방 내역이 없어요. </Text>
                      ...
                      <View style={styles.hospitalInfoContainer}>
                        ...
                        <View style={styles.row}>
                          <View style={[{ paddingTop: 5 }]}>
                            ...
                            <Text
                              style={[styles.hospitalInfo, {width: 240},{ paddingTop: 20 }]}
                              numberOfLines={1}
                              ellipsizeMode="tail"
                            >
                              {item.agencyAddress}
                            </Text>
                            <Text style={styles.hospitalInfo}> {item.agencyTel}</Text>
                          </View>
                        </View>
                        <TouchableOpacity
