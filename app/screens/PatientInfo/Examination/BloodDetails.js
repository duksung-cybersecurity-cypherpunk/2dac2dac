        ...
        <View style={styles.scrollView}>
          ...
          <Text
            style={[
              styles.valueBox,
              { width: "10%" },
              { left: `${calculateHemoglobinPosition(item.hemoglobin) - 4}%` },
            ]}
          >
            {item.hemoglobin}
          </Text>
          <Text
            style={{ left: `${calculateHemoglobinPosition(item.hemoglobin)}%` }}
          >
            |
          </Text>
        ...
        <View style={styles.scrollView}>
          ...
          <Text
            style={[
              ...
              {
                left: `${
                  calculatefastingBloodSugarPosition(item.fastingBloodSugar) - 4
                }%`,
              },
            ]}
          >
          ...
          <Text
            style={{
              left: `${calculatefastingBloodSugarPosition(
                item.fastingBloodSugar
              )}%`,
            }}
          >
        ...
        <View style={styles.scrollView}>
          ...
          <Text
            style={[
              ...
              {
                left: `${
                  calculateTotalCholesterolPosition(item.totalCholesterol) - 6
                }%`,
              },
            ]}
          >
          ...
          <Text
            style={{
              left: `${calculateTotalCholesterolPosition(
                item.totalCholesterol
              )}%`,
            }}
          >
        ...
        <View style={styles.scrollView}>
          ...
          <Text
            style={[
              ...
              {
                left: `${
                  calculateHdlcholesterolPosition(item.hdlcholesterol) - 4
                }%`,
              },
            ]}
          >
          ...
          <Text
            style={{
              left: `${calculateHdlcholesterolPosition(item.hdlcholesterol)}%`,
            }}
          >
            |
          </Text>
        ...
        <View style={styles.scrollView}>
          ...
          <Text
            style={[
              ...
              {
                left: `${
                  calculateTriglyceridePosition(item.triglyceride) - 6
                }%`,
              },
            ]}
          >
          ...
          <Text
            style={{
              left: `${calculateTriglyceridePosition(item.triglyceride)}%`,
            }}
          >
            |
          </Text>
        ...
        <View style={styles.scrollView}>
          ...
          <Text
            style={[
              ...
              {
                left: `${
                  calculateLdlcholesterolPosition(item.ldlcholesterol) - 6
                }%`,
              },
            ]}
          >
          ...
          <Text
            style={{
              left: `${calculateLdlcholesterolPosition(item.ldlcholesterol)}%`,
            }}
          >
            |
          </Text>
        ...
        <View style={styles.scrollView}>
          ...
          <Text
            style={[
              ...
              {
                left: `${
                  calculateSerumCreatininePosition(item.serumCreatinine) - 4
                }%`,
              },
            ]}
          >
            {item.serumCreatinine}
          </Text>
          <Text
            style={{
              left: `${calculateSerumCreatininePosition(
                item.serumCreatinine
              )}%`,
            }}
          >
        ...
        <View style={styles.scrollView}>
          ...
          <Text
            style={[
              styles.valueBox,
              { width: "10%" },
              { left: `${calculateGfrPosition(item.gfr) - 4}%` },
            ]}
          >
            {item.gfr}
          </Text>
        ...
        <View style={styles.scrollView}>
          ...
          <Text
            style={[
              styles.valueBox,
              { width: "10%" },
              { left: `${calculateAstPosition(item.ast) - 4}%` },
            ]}
          >
            {item.ast}
          </Text>
        ...
        <View style={styles.scrollView}>
          ...
          <Text
            style={[
              styles.valueBox,
              { width: "10%" },
              { left: `${calculateAltPosition(item.alt) - 4}%` },
            ]}
          >
            {item.alt}
          </Text>
        ...
        <View style={styles.scrollView}>
          ...
          <Text
            style={[
              styles.valueBox,
              { width: "10%" },
              { left: `${calculateGptPosition(item.gpt) - 4}%` },
            ]}
          >
            {item.gpt}
          </Text>
